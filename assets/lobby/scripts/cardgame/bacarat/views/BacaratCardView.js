...
(function () {
    cc.BacaratCardView = cc.Class({
        ...
        resetLayoutCard: function () {
            ...
            for (var i = 0; i < 3; i++)
                this.popupWinSides[i].active = false;
        },
            ...
            if (!cc.game.isPaused()) {
                ...
                if (ordinalPlayerCard3 != 0) {
                    if (!cc.game.isPaused()) {
                        ...
                        //Game pause
                        this.playerCard3Item.forceShowCard(playerCardsPos[2]);
                        this.showScoreArr({
                            player: [ordinalPlayerCard1, ordinalPlayerCard2, ordinalPlayerCard3],
                            banker: [ordinalBankerCard1, ordinalBankerCard2]
                        });
                ...
                this.bankerCard1Item.forceShowCard(bankerCardsPos[0]);
                this.bankerCard2Item.forceShowCard(bankerCardsPos[1]);
                this.bankerCard3Item.forceShowCard(bankerCardsPos[2]);
                //Hien thi diem
                this.showScoreArr({
                    player: [ordinalPlayerCard1, ordinalPlayerCard2, ordinalPlayerCard3],
                    banker: [ordinalBankerCard1, ordinalBankerCard2, ordinalBankerCard3]
        ...
        showGateWin: function (gateData) {
            ...
            if (lstWin.includes('2')) this.popupWinSides[0].active = true;
            if (lstWin.includes('4')) this.popupWinSides[1].active = true;
            if (lstWin.includes('3')) this.popupWinSides[2].active = true;
        },
